...
{
    HOENN_TO_NATIONAL(THISTLETOT),
    HOENN_TO_NATIONAL(BRISTLEBLOOM),
    HOENN_TO_NATIONAL(THORNAMENT),
    HOENN_TO_NATIONAL(CALFIRE),
    HOENN_TO_NATIONAL(BLAZEBELL),
    HOENN_TO_NATIONAL(PYROHIGH),
    HOENN_TO_NATIONAL(PUFFLET),
    HOENN_TO_NATIONAL(TUFFIN),
    HOENN_TO_NATIONAL(GULPUFF),
    HOENN_TO_NATIONAL(BOGLIN),
    HOENN_TO_NATIONAL(CREMELETTE),
    HOENN_TO_NATIONAL(RASPBERRYNE),
    HOENN_TO_NATIONAL(DRACELT),
    HOENN_TO_NATIONAL(AURORANE),
    HOENN_TO_NATIONAL(UMBRATHAL),
    HOENN_TO_NATIONAL(NYMPHALGA),
